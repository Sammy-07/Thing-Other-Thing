...
void manual() {
    ...
    if (help_command == "version") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Displays the version of the running program.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "time") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Shows the time in a weird format.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "sudo?") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Tells you if administrator is on.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }
    ...
    if (help_command == "sudo") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "If given the correct password enables administrator allowing you to use some\ncommands you would be unable to use otherwise.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }
    ...
    if (help_command == "sum") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Will ask for two numbers add them together and tell you the result.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "multiply") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Will ask for two numbers to then multiply them and give you the result.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "math") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Asks for the first number then an operator followed by a second number and gives\nyou the result.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "rand-l") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Gives you a large random number.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "rand-10") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Gives you a random number from 1 to 10 or 0 to 10 don't remember.";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }

    if (help_command == "coinflip") {
        cout << "\n--------------------------------------------------------------------------------\n";
        cout << "Gives you a random number between 0 and 1 in simple terms its a coin flip";
        cout << "\n--------------------------------------------------------------------------------\n";
        manual();
    }
}
